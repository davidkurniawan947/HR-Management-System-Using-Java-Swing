...
public class PanelEmployee extends javax.swing.JPanel implements ListSelectionListener{
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addComponent(salary)
                                            .addComponent(hire, javax.swing.GroupLayout.DEFAULT_SIZE, 226, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        } else if (hire.getDate() == null) {
            JOptionPane.showMessageDialog(this, "Hire Date is required!", "Warning Message", 2);
    ...
    private void save() {
        if (employee.getEmployeeId() == null) {
            ...
            employee.setHireDate(hire.getDate());
    ...
    public void valueChanged(ListSelectionEvent e) {
        if (e.getSource() == tabelEmp.getSelectionModel())
            try {
                ...
                hire.setDate(employee.getHireDate());
